...
API_ID = int(environ.get('API_ID', '6484563')) # API ID from my.telegram.org
API_HASH = environ.get('API_HASH', '7f6d6a93690a26c3200b43ef3dd7c31c')  # API Hash from my.telegram.org
...
PICS = (environ.get('PICS', 'https://files.catbox.moe/t3h55t.jpg')).split() #random anime girl img each time from aniwallpaper (Experimental)
...
SUBSCRIPTION = (environ.get('SUBSCRIPTION', 'https://i.ibb.co/Dfk6cf0Q/x.jpg'))
...
# ============================
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1685453419 5685076977').split()] # Replace with the actual admin ID(s) to add
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '1002975880920').split()]  # Channel id for auto indexing (make sure bot is admin)

LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1003672261000'))  # Log channel id (make sure bot is admin)
BIN_CHANNEL = int(environ.get('BIN_CHANNEL', '1003672261000'))  # Bin channel id (make sure bot is admin)
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1003354519663')  # Support group id (make sure bot is admin)
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1001919464735')  # Request channel id (make sure bot is admin)
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/+Yz90-B7ZZDQzZjI1')  # Support group link (make sure bot is admin)

# FORCE_SUB 
auth_req_channels = environ.get("AUTH_REQ_CHANNELS", "1001919464735")# requst to join Channel for force sub (make sure bot is admin) only for bot ADMINS  
auth_channels     = environ.get("AUTH_CHANNELS", "1003432202270")# Channels for force sub (make sure bot is admin)

# ============================
# Payment Configuration
# ============================
QR_CODE = environ.get('QR_CODE', 'https://i.ibb.co/Dfk6cf0Q/x.jpg')    # QR code image for payments
OWNER_UPI_ID = environ.get('delhisehoon11784@ptyes', 'delhisehoon11784@ptyes')    # Owner UPI ID for payments
...
# ============================
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Delhisehoon:Delhisehoon@cluster0.v3gooma.mongodb.net/?appName=Cluster0")  # MongoDB URI for the database
DATABASE_NAME = environ.get('DATABASE_NAME', "Delhisehoon") # Database name (default: cluster)
...
LOG_VR_CHANNEL = int(environ.get('LOG_VR_CHANNEL', '1003672261000')) #Verification Channel Id 
LOG_API_CHANNEL = int(environ.get('LOG_API_CHANNEL', '1003672261000')) #If Anyone Set Your Bot In Any Group And Set Shortner In That Group Then In This Channel The All Details Come
VERIFY_IMG = environ.get("VERIFY_IMG", "https://i.ibb.co/Dfk6cf0Q/x.jpg")
...
# ============================
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+CTwqa5gTVQcyZWZl') # Group link for the bot
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/Movies_1783') # Owner link for the bot
UPDATE_CHNL_LNK = environ.get('UPDATE_CHNL_LNK', 'https://t.me/Movies_1770') # Update channel link for the bot
